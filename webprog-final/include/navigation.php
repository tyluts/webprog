    ...
    <nav class="navbar navbar-expand-lg mx-auto  my-4 nav-width border-radius sticky-top dark-grey  ">
        <div class="  container-fluid ">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                ...
                <div class="navbar-nav login-nav border-radius">
                    <li class="nav-item border-radius ">
                        <a class="nav-link login-link bg-red  border-radius " href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat-right-dots-fill" viewBox="0 0 16 16">
